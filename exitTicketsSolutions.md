...
Question 2: If you had the choice of two algorithms to solve the same problem, and one was O(log(n)) and the other was O(n^2), which would you choose? Why?
...
Answer: Many different answers apply.  Answers include view hierarchy and directory/file structure
